 ...
 ELSE( WIN32 )
     ...
     EXECUTE_PROCESS(COMMAND ${CMAKE_WX_CONFIG} --cxxflags OUTPUT_VARIABLE CMAKE_WX_CXX_FLAGS)
     EXECUTE_PROCESS(COMMAND ${CMAKE_WX_CONFIG} --libs OUTPUT_VARIABLE WX_CONFIG_LIBS)


     STRING(REGEX MATCHALL "[-][D]([^ ;])+" WXWINDOWS_DEFINITIONS "${CMAKE_WX_CXX_FLAGS}" )
     #MESSAGE("DBG  WXWINDOWS_LINK_DIRECTORIES_WITH_PREFIX=${WXWINDOWS_LINK_DIRECTORIES_WITH_PREFIX}")

     ## extract linkdirs (-I) for rpath
     ## use regular expression to match wildcard equivalent "-L*<endchar>"
     ## with <endchar> is a space or a semicolon
     STRING(REGEX MATCHALL "[-][I]([^ ;])+" WXWINDOWS_INCLUDE_DIR "${CMAKE_WX_CXX_FLAGS}" )
     #MESSAGE("DBG  WXWINDOWS_LINK_DIRECTORIES_WITH_PREFIX=${WXWINDOWS_LINK_DIRECTORIES_WITH_PREFIX}")
     ...
     ## feature?)
     IF(WXWINDOWS_INCLUDE_DIR)
       STRING(REGEX REPLACE "([-][I])" ";" WXWINDOWS_INCLUDE_DIR ${WXWINDOWS_INCLUDE_DIR} )
 ...
 #MESSAGE( "${WXWINDOWS_LINK_LIBRARIES}" )
