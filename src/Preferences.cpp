...
DECLARE_PREF_GET(bool, ColorFContourBorderDraw)
...
PreferencesDialog_( parent )
{
	...
	SET_CONTROL_VALUE(ColorFContourBorderDraw)
...
void Preferences::OnRestoreDefaults( wxCommandEvent& e )
{
	...
	SET_CONTROL_VALUE_DEFAULT(ColorFContourBorderDraw)
...
void Preferences::OnSave( wxCommandEvent& e )
{
	...
	GET_CONTROL_VALUE(ColorFContourBorderDraw)
...
#define PREF_WRITE_VALUE_LONG(NAME)	\
	...
	PREF_WRITE_VALUE(ColorFContourBorderDraw)
...
#define PREF_INIT_COLOUR(NAME)	\
	...
	PREF_INIT_BOOL(ColorFContourBorderDraw)
